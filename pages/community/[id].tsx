...
const CommunityPostEdtail: NextPage = () => {
  return (
    <div>
      <span className="px-2.5 my-3 py-0.5 inline-flex items-center bg-slate-100 ml-3 text-gray-800 rounded-full text-xs font-medium">
        동네질문
      </span>
      ...
      <div>
        <div className="px-4 mt-2 text-gray-700 font-bold">
          <span className="text-orange-500 font-medium">Q.</span> What is the
          best mandu restaurant?
        </div>
        <div className="px-4 flex space-x-5 mt-3 text-gray-700 py-2.5  border-b-[3px] w-full">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-2">
              The best dimpsum restaurant is the one next to my house
            </p>
          </div>
        </div>      
        <div className="flex items-start space-x-3">
...
export default CommunityPostEdtail;
